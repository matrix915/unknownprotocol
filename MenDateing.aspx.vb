...
Partial Class MenDateing
    ...
    Function DataSource() As ICollection
        ...
        Dim Cmd As SqlDataAdapter = New SqlDataAdapter("Select * from tblRegisteredUsers WHERE Relationships = '" & "Mendateing" & "'", Connection)
    ...
    Protected Sub btnLNSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLNSearch.Click
        ...
        Dim RegistrationConnection As SqlConnection = New SqlConnection("Server=D7BBFM83\DIGITALBDS;database=Registration;uid=sa;password=1AbrianA1;")
