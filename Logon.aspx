<%@ Page Title="Logon" Language="VB" AutoEventWireup="false" CodeFile="logon.aspx.vb" Inherits="Logon" %>
...
<body>
            ...
            <asp:Menu ID="NavigationMenu" runat="server" CssClass="menu" EnableViewState="false" IncludeStyleBlock="false" Orientation="Horizontal">
                    <Items>
                        ...
                        <asp:MenuItem NavigateUrl="~/ForgotUsername.aspx" Text="Forgot Username" Value="Forgot Password"></asp:MenuItem>
...
ErrorMessage="Password must be 8-10 characters" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{10,}$" />
        
      </td>
   </tr>
   <tr>
      <td>Stay Logged On:</td>
...
<input type="submit" Value="Logon" runat="server" ID="cmdLogin"><p>
                     ...
                     <p>
                         <br />
                         <asp:HyperLink ID="hyperlink2" runat="server" ImageUrl="" NavigateUrl="~/privacy.aspx" Target="_self" Text="Privacy" />
                         &nbsp;|
                         <asp:HyperLink ID="hyperlink3" runat="server" ImageUrl="" NavigateUrl="~/termsofuse.aspx" Target="_self" Text="Terms Of Use" />
                     </p>
            </form>
<script>
