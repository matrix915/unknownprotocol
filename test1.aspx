<%@ Page Title="Test" Language="VB" AutoEventWireup="false" EnableEventValidation="false" CodeFile="test1.aspx.vb"
    Inherits="test1" %>
    <!DOCTYPE html
...
----------------------------------------------------------*/
    ...
    <body>
        ...
        <asp:SqlDataSource id="RegisteredInsert" runat="server"
            ...
            CurrentAge,Gender,HeightFeet,HeightInches,WeightPounds,WeightOunces,HairColor,EyeColor,Drinks,Smokes,MaritalStatus,Email,DateTime)
            
            VALUES (@RelationshipID,@URLOfPicture,@FirstName,@MiddleName,@LastName,
            @Address,@Country,@State,@City,@ZipCode,
            @CurrentAge,@Gender,@HeightFeet,@HeightInches,@WeightPounds,@WeightOunces,@HairColor,@EyeColor,@Drinks,@Smokes,@MaritalStatus,
                @Email,@DateTime)">
