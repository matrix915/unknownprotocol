<%@ Page Title="Test" Language="VB" AutoEventWireup="false" CodeFile="test2.aspx.vb" Inherits="test2" %>
    <!DOCTYPE html
                        ...
                        <div class="clear hideSkiplink">
                            <asp:Menu ID="NavigationMenu" runat="server" CssClass="menu" EnableViewState="false"
                                ...
                                <Items>
                                    ...
                                    <asp:MenuItem NavigateUrl="DeleteUser.aspx" Text="Delete User" Value="Delete User">
                                    </asp:MenuItem>
                                </Items>
                            </asp:Menu>
                        </div>
                    ...
                    <center>
                        <fieldset>
                            ...
                            <div class="main">
                                ...
                                <asp:TextBox ID="txtFirstName" CssClass="textEntry" MaxLength="20" runat="server">
                                </asp:TextBox>
                                <br />

                                <asp:Label ID="lblMiddleName" runat="server" Text="Middle Name"></asp:Label><br />
                                <asp:TextBox ID="txtMiddleName" CssClass="textEntry" MaxLength="20" runat="server">
                                </asp:TextBox>

                                <br />

                                <asp:Label ID="lblLastName" runat="server" Text="Last Name"></asp:Label><br />
                                <asp:TextBox ID="txtLastName" CssClass="textEntry" MaxLength="20" runat="server">
                                </asp:TextBox>
                                <br />
                                ...
                                <asp:Label ID="lblCurrentAge" Text="Age" runat="server"></asp:Label>
                                <br />
                                ...
                                <asp:Label ID="lblDrinks" runat="server" Text="Drinks"></asp:Label><br />
                                ...
                                <br />
                                <asp:Label ID="lblSmokes" runat="server" Text="Smokes"></asp:Label><br />
                                ...
                                <asp:Label ID="lblUpdateRecord" runat="server"></asp:Label>
                                ...
                                <asp:SqlDataSource id="RegisteredUpdate" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:SqlDataSource1 %>"
                                    selectcommand="SELECT [RelationshipID] FROM [tblUpdateRegistered])"
                                    UpdateCommand="UPDATE tblUpdateRegistered SET URLOfPicture=@URlOfPicture,RelationshipID=@RelationshipID,
                 FirstName=@FirstName,MiddleName=@MiddleName,LastName=@LastName,Country=@Country,State=@State,Address=@Address,City=@City,
                 ZipCode=@ZipCode,CurrentAge=@CurrentAge,Gender=@Gender,HeightFeet=@HeightFeet,HeightInches=@HeightInches,
                 WeightPounds=@WeightPounds,WeightOunces=@WeightOunces,HairColor=@HairColor,EyeColor=@EyeColor,Drinks=@Drinks,
                 Smokes=@Smokes,MaritalStatus=@MaritalStatus,Email=@Email,DateTime=@DateTime WHERE ([RelationshipID] = @ID)">
                                ...
                                <asp:SqlDataSource id="RegisteredUpdate1" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:SqlDataSource1 %>"
                                    UpdateCommand="UPDATE tblRegistered SET URLOfPicture=@UrlOfPicture, FirstName=@FirstName,  MiddleName=@MiddleName, LastName=@Lastname WHERE ([ID] = @ID)">
                                ...
                                <asp:SqlDataSource id="RegisteredUpdate2" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:SqlDataSource1 %>"
                                    UpdateCommand="UPDATE tblRegisteredUsers SET URLOfPicture=@URLOfPicture, FirstName1=@FirstName1,  MiddleName1=@MiddleName1, LastName1=@Lastname1 WHERE ([RelationshipID] = @ID)">
                                ...
                                <asp:SqlDataSource id="RegisteredUpdate3" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:SqlDataSource1 %>"
                                    UpdateCommand="UPDATE tblUsersRegistered SET URLOfPicture=@URLOfPicture, FirstName=@FirstName,  MiddleName=@MiddleName, LastName=@Lastname  WHERE ([RelationshipID] = @ID)">
