...
cities['North America']['United States']['New Jersey'] = new Array('Select a city', 'Absecon', 'Asbury Park', 'Atlantic City', 'Bordentown', 'Bridgeton', 'Brigantine', 'Burlington', 'Camden', 'Cape May', 'Clifton', 'Egg Harbor City ', 'Elizabeth', 'Hackensack', 'Highland Park', 'Kinnelon', 'Lambertville', 'Linden', 'Long Branch', 'Madison', 'Metuchen', 'Middletown', 'Metuchen', 'Neptune', 'New Brunswick', 'New Egypt', 'New Providence', 'Newark', 'Oakland', 'Ocean City', 'Paramus', 'Passaic', 'Paterson', 'Perth Amboy', 'Planfield', 'Pleasantville', 'Rahway', 'Ramsey', 'Salem', 'Sayreville', 'Sea Isle City', 'Somers Point', 'Trenton', 'Tuckerton', 'Union', 'Vetnor City', 'Vineland', 'Wildwood', 'Woodbury');
cities['North America']['United States']['New Mexico'] = new Array('Select a city', 'Alamogordo', 'Albuquerque', 'Anthony', 'Artesia', 'Aztec', 'Bayard', 'Belen', 'Bloomfield', 'Carlsbad', 'Clovis', 'Deming', 'Espanola', 'Estancia', 'Eunice', 'Farmington', 'Gallup', 'Grants', 'Hobbs', 'Jal', 'Las Cruces', 'Las Vegas', 'Lordsburg', 'Lovington', 'Moriarty', 'Portales', 'Raton', 'Rio Rancho', 'Roswell', 'Santa Fe', 'Santa Rosa', 'Socorro', 'Sunland Park', 'Texico', 'Truth or Consequences', 'Tucumcari', 'University Park');
...
towns['North America']['United States']['New Jersey'] = new Array('Select a town', 'Atlantic Highlands', 'Audubon', 'Beachwood', 'Belleville', 'Belvidere', 'Berlin', 'Bernardsville', 'Blackwood', 'Booton', 'Bound Brook', 'Browns Mills', 'Budd Lake', 'Buena', 'Caldwell', 'Cape May Courthouse', 'Clinton', 'Cranbury', 'Denville', 'Dover', 'Eatontown', 'Edison', 'Flemington', 'Folsom', 'Forked River', 'Franklin', 'Freehold', 'Glassboro', 'Hackettstown', 'Hamburg', 'Hammonton', 'High Bridge', 'Elmer', 'Ewing', 'Highlands', 'Hightstown', 'Hopatcong', 'Hope', 'HopeWell', 'Jamesburg', 'Keansburg', 'Lakehurst', 'Lakewood', 'Lawrenceville', 'Lebanon', 'Litttle Silver', 'Mahwah', 'Malaga', 'Manahawkin', 'Manville', 'Marlton', 'Matawan', 'Mays Landing', 'Medford', 'Middletown', 'Montclair', 'Morris Plains', 'Morristown', 'Mount Holly', 'Netcong', 'Newton', 'Ocean Grove', 'Old Bridge', 'Paulsboro', 'Penns Grove', 'Pensville', 'Phillipsburg', 'Piscataway', 'Pleasantville', 'Princeton', 'Raritan', 'Red Bank', 'Rio Grande', 'Rochell Park', 'Scotch Plains', 'Sea Girt', 'Seaside Heights', 'Seaside Park', 'Somerdale', 'Somerville', 'South River', 'Spring Lake Heights', 'Sussex', 'Toms River', 'Villas', 'Wanaque', 'Washington', 'West Milford', 'West Orange', 'Williamstown', 'Woodstown', 'Wyckoff');
towns['North America']['United States']['New Mexico'] = new Array('Select a town', 'Alameda', 'Bernalillo', 'Carizozo', 'Cedar Crest', 'Clayton', 'Crownpoint', 'Dexter', 'Dulce', 'Edgewood', 'Hagerman', 'Hurley', 'Los Alamos', 'Mescalero', 'Mesquite', 'Mora', 'Mountainair', 'Organ', 'Pecos', 'Penasco', 'Pojoaque Valley', 'Radium Springs', 'Ranchos de Toas', 'Reserve', 'San Rafael', 'Sandia Park', 'Santo Domingo Pueblo', 'Shiprock', 'Silver City', 'Springer', 'Taos', 'Tatum', 'Thoreau', 'Tierra Amarilla', 'Tohatchi', 'Vaughn', 'Zuni');
...
islands['North America']['United States']['New York'] = new Array('Select a city');
