<%@ Page Title="Delete Contact" Language="VB" AutoEventWireup="false"
    CodeFile="DeleteContact.aspx.vb" Inherits="DeleteContact" %>
...
<td>
    Email:</td>
<td class="style26">
<asp:TextBox ID="txtEmail" runat="server" AutoPostBack="False" CssClass="textEntry" Width="320px"></asp:TextBox>   
</td>
...
<td class="style7" colspan="2">
    <center>
                <br />
<asp:Button ID="btnDelete" runat="server" style="text-align: center" Text="Delete" 
