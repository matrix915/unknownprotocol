<%@ Page Title="UpdateContact" Language="VB" AutoEventWireup="false" CodeFile="UpdateContact.aspx.vb" Inherits="UpdateContact" %>
    <!DOCTYPE html
                ...
                <div class="main">
                  ...
                  runat="server"/>
                                ...
                                <asp:SqlDataSource id="RegisteredUpdate" runat="server"
                                    ...
                                    UpdateCommand="UPDATE tblUpdateRegistered SET URLOfPicture=@URlOfPicture,FirstName=@FirstName,
                                    MiddleName=@MiddleName,LastName=@LastName,Country=@Country,State=@State,Address=@Address,City=@City,
                                    ZipCode=@ZipCode,CurrentAge=@CurrentAge,Gender=@Gender,HeightFeet=@HeightFeet,HeightInches=@HeightInches,
                                    WeightPounds=@WeightPounds,WeightOunces=@WeightOunces,HairColor=@HairColor,EyeColor=@EyeColor,MaritalStatus=@MaritalStatus,DateTime=@DateTime WHERE ([RelationshipID] = @ID)">
