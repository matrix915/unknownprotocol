...
Partial Class ContactInformation
    ...
    Protected Friend DeleteID As String
    Protected Friend EmailDelete As String
    Protected Friend IDEmail As String
    ...
    'Dim RelationshipDelete As String = "Delete tblUpdateRegistered WHERE RelationshipID = '" & ID & "' And Email = '" & Email & "'"
