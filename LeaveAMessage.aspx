<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LeaveAMessage.aspx.vb" Inherits="LeaveAMessage" %>
...
.submitButton
{
  ...
  <body attr="<%=Email%>">
    ...
    <center><asp:TextBox ID="txtMessage" maxlength = "200" runat="server" Height="225px" Width="275px" TextMode="MultiLine">
    </asp:TextBox>
    </center>
    <center>
       ...
       <asp:sqldatasource
        ...
        insertcommand="INSERT INTO tblMessages (URLOfPicture, PictureURL, FirstName, MiddleName, LastName, IDControl, MessagesID, Messages, FollowUnFollow, Email, DateTime) VALUES (@URLOfPicture, @PictureURL, @FirstName, @MIddleName, @LastName, @IDControl, @MessagesID, @Messages, @FollowUnFollow, @Email,  @DateTime)">
          <insertparameters>
            <asp:FormParameter Name="PictureURL" formfield="FileUpload"/>
          
            <asp:FormParameter name="Messages" formfield="txtMessage" />
            </insertparameters>
      </asp:sqldatasource>
